...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="md:hidden bg-slate-900 dark:bg-slate-950 text-slate-200 dark:text-slate-400 p-4 flex justify-between items-center sticky top-0 z-50">
      ...
      <div className={`
        ...
        w-64 bg-slate-900 dark:bg-slate-950 text-slate-300 dark:text-slate-400 h-screen p-4 flex flex-col border-r border-slate-800
      `}>
        <div className="hidden md:flex justify-between items-center mb-8">
          <div className="text-xl font-bold flex items-center gap-2 text-slate-200 dark:text-slate-300">
            <span>🦾</span> Jarvis Wiki
          </div>
        ...
        <div className="pt-4 border-t border-slate-800 mt-4">
          <div className="px-3 py-2 bg-blue-500/10 rounded-xl border border-blue-500/20">
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500">Connected to Mac Mini</p>
          </div>
        </div>
      </div>
