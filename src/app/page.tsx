export default function Home() {
  return (
    <div className="max-w-4xl mx-auto py-12 text-center">
      <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight text-slate-900 dark:text-slate-200">
        Jarvis Wiki 아카이브
      </h1>
      <p className="text-lg md:text-xl text-slate-600 dark:text-slate-500 mb-12 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-0">
        {[
          ...
          <a
            ...
            className="group p-8 bg-white dark:bg-slate-900/40 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-500/50 transition-all text-left relative overflow-hidden"
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-slate-900 dark:text-slate-300">{agent.name}</h3>
